    ...
    <header id="header" class="header-section" style="background-color:darkblue;">
        <div class="container">
            <nav class="navbar">
                <a href="#" class="navbar-brand">
                    <img src="Design/images/morgan-logo.jpg" alt="Barbershop Logo">
                </a>
                <div class="d-flex menu-wrap align-items-center main-menu-container">
                    ...
                    <div class="header-btn" style="margin-left:10px">
                        <a href="appointment.php" class="menu-btn" style="background-color:green;">Make Appointment</a>
                    </div>
                </div>
